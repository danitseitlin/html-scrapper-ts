 ...
 */
export const supportedElements = ['table', 'tbody', 'thead', 'h1', 'tr', 'td', 'input', 'select', 'option', 'div', 'a'];

/**
 * The supported properties that have an '=' sign
 */
export const supportedPropertiesWithValue = ['type', 'value', 'id', 'class', 'style'];
